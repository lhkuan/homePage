    ...
    <el-row :gutter="40">
      <el-col :span="12" class="left">
        ...
        <div class="version">
          ...
          <el-tooltip content="喵~~" placement="right" :show-arrow="false">
...
const upData = reactive({
  new: [
    "2024年5月5日，添加卖板打油诗",
    "2024年5月3日，更新联系方式图标及首页后台链接",
    "2024年5月1日，当天上线网站首页",
    "2024年5月1日，域名lidu.ltd申请成功",
  ],
  fix: ["2024年4月，主页代码完成", "2023年12月，完善细节", "2023年 6月，无意间遇到大佬指点迷津", "2023年2月，过年期间突发灵感，做个网站"],
});
